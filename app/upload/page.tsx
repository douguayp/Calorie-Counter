      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-green-700">Photo Recognition</h1>
          ...
          {!selectedImage ? (
            <Card className="backdrop-blur-sm bg-white/90 border-0 shadow-xl">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-green-700">Select Food Image</CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-4">
                ...
                <Button 
                  ...
                  variant="outline"
                  className="w-full border-2 border-green-200 hover:bg-green-50 text-green-700 font-semibold py-6 text-lg rounded-xl"
                >
            ...
            <Card className="backdrop-blur-sm bg-white/90 border-0 shadow-xl">
              <CardHeader className="text-center">
                <CardTitle className="text-green-700">Image Preview</CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-6">
                ...
                {isAnalyzing ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-green-700 font-semibold">Recognizing food...</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <Button 
                      onClick={resetImage}
                      variant="outline"
                      className="w-full border-2 border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl"
                    >
